...
function CellActions({ row }: { row: Row<Category> }) {
  const category = row;
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        <DropdownMenuItem
          onClick={() => navigator.clipboard.writeText(category.original.id)}
          className="gap-2"
        >
        ...
        <DropdownMenuItem>
          <Link
            href={`/dashboard/categories/${category.original.id}`}
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  usunie tą kategorie z bazy danych.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
